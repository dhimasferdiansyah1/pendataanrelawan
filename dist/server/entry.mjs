...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/relawan.ts",
			"pathname": "/api/relawan",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/terima-kasih.astro",
			"pathname": "/terima-kasih",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/node_usLIO3wU.mjs");
var _page1 = () => import("./chunks/admin_Cmhw2MwA.mjs");
var _page2 = () => import("./chunks/login_Bg32uOj2.mjs");
var _page3 = () => import("./chunks/relawan_Ddv_i-hM.mjs");
var _page4 = () => import("./chunks/terima-kasih_JjtsWiZJ.mjs");
var _page5 = () => import("./chunks/index_DzDhK4i_.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/node.js", _page0],
	["src/pages/admin.astro", _page1],
	["src/pages/api/login.ts", _page2],
	["src/pages/api/relawan.ts", _page3],
	["src/pages/terima-kasih.astro", _page4],
	["src/pages/index.astro", _page5]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///E:/website/pendataanrelawan/","cacheDir":"file:///E:/website/pendataanrelawan/node_modules/.astro/","outDir":"file:///E:/website/pendataanrelawan/dist/","srcDir":"file:///E:/website/pendataanrelawan/src/","publicDir":"file:///E:/website/pendataanrelawan/public/","buildClientDir":"file:///E:/website/pendataanrelawan/dist/client/","buildServerDir":"file:///E:/website/pendataanrelawan/dist/server/","adapterName":"@astrojs/node","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/node.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.DMyBZTBH.css"}],"routeData":{"route":"/admin","isIndex":false,"type":"page","pattern":"^\\/admin\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin.astro","pathname":"/admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/login","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/login\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/login.ts","pathname":"/api/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/relawan","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/relawan\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"relawan","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/relawan.ts","pathname":"/api/relawan","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.DMyBZTBH.css"}],"routeData":{"route":"/terima-kasih","isIndex":false,"type":"page","pattern":"^\\/terima-kasih\\/?$","segments":[[{"content":"terima-kasih","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/terima-kasih.astro","pathname":"/terima-kasih","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.DMyBZTBH.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["E:/website/pendataanrelawan/src/pages/admin.astro",{"propagation":"none","containsHead":true}],["E:/website/pendataanrelawan/src/pages/index.astro",{"propagation":"none","containsHead":true}],["E:/website/pendataanrelawan/src/pages/terima-kasih.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.DJJQTzi7.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_DS5V7T-N.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/node/server.js":"entry.mjs","\u0000virtual:astro:page:src/pages/admin@_@astro":"chunks/admin_Cmhw2MwA.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DzDhK4i_.mjs","\u0000virtual:astro:page:src/pages/api/login@_@ts":"chunks/login_Bg32uOj2.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/node@_@js":"chunks/node_usLIO3wU.mjs","\u0000virtual:astro:page:src/pages/api/relawan@_@ts":"chunks/relawan_Ddv_i-hM.mjs","E:/website/pendataanrelawan/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_BoEQmWFd.mjs","\u0000virtual:astro:page:src/pages/terima-kasih@_@astro":"chunks/terima-kasih_JjtsWiZJ.mjs","E:/website/pendataanrelawan/src/components/DaftarRelawan.astro?astro&type=script&index=0&lang.ts":"_astro/DaftarRelawan.astro_astro_type_script_index_0_lang.CeD2W_Rh.js","E:/website/pendataanrelawan/src/components/FormRelawan.astro?astro&type=script&index=0&lang.ts":"_astro/FormRelawan.astro_astro_type_script_index_0_lang.BHrihFlk.js","E:/website/pendataanrelawan/src/pages/admin.astro?astro&type=script&index=0&lang.ts":"_astro/admin.astro_astro_type_script_index_0_lang.BTiaTJTM.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["E:/website/pendataanrelawan/src/components/FormRelawan.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`namaLengkap`),t=document.getElementById(`nameDropdown`),n=document.getElementById(`toggleDropdownBtn`),r=document.getElementById(`dropdownArrow`),i=document.getElementById(`jenisKelamin`),a=window.MASTER_RELAWAN_LIST,o=e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\"/g,`&quot;`),s=(n=``)=>{let r=n.toLowerCase().trim(),s=r?a.filter(e=>e.nama.toLowerCase().includes(r)):a;s.length?(t.innerHTML=s.map(e=>`\n        <button type=\"button\"\n          class=\"dropdown-item w-full text-left px-3 py-2.5 text-sm flex items-center justify-between hover:bg-slate-50 transition-colors\"\n          data-nama=\"${o(e.nama)}\" data-jk=\"${e.jk}\">\n          <span class=\"font-medium text-slate-800\">${o(e.nama)}</span>\n          <span class=\"text-xs px-2 py-0.5 rounded-full font-semibold ${e.jk===`L`?`bg-blue-50 text-blue-700`:`bg-pink-50 text-pink-700`}\">\n            ${e.jk===`L`?`L`:`P`}\n          </span>\n        </button>\n      `).join(``),t.querySelectorAll(`.dropdown-item`).forEach(t=>{t.addEventListener(`click`,()=>{e.value=t.dataset.nama,i.value=t.dataset.jk===`L`?`Laki-laki`:`Perempuan`,l()})})):t.innerHTML=`<div class=\"px-3 py-2.5 text-xs text-slate-400 italic\">Nama tidak ditemukan dalam daftar.</div>`},c=()=>{s(e.value),t.classList.remove(`hidden`),r?.classList.add(`rotate-180`)},l=()=>{t.classList.add(`hidden`),r?.classList.remove(`rotate-180`)};e.addEventListener(`focus`,c),e.addEventListener(`input`,()=>{c();let t=a.find(t=>t.nama.toLowerCase()===e.value.toLowerCase().trim());t&&(i.value=t.jk===`L`?`Laki-laki`:`Perempuan`)}),n?.addEventListener(`click`,e=>{e.stopPropagation(),t.classList.contains(`hidden`)?c():l()}),document.addEventListener(`click`,e=>{document.getElementById(`searchableNameContainer`)?.contains(e.target)||l()});var u=document.getElementById(`tanggalLahir`),d=document.getElementById(`dateWrapper`),f=()=>{try{u.showPicker?.()}catch{}};u?.addEventListener(`click`,f),u?.addEventListener(`focus`,f),d?.addEventListener(`click`,e=>{e.target!==u&&(u?.focus(),f())});var p=document.getElementById(`nik`),m=document.getElementById(`nikCounter`),h=document.getElementById(`nikStatusIcon`);p?.addEventListener(`input`,()=>{let e=p.value.replace(/\\D/g,``).slice(0,16);p.value=e,m.textContent=`${e.length}/16`,e.length===16?(m.className=`text-xs text-emerald-600 font-mono font-bold`,h.classList.remove(`hidden`)):(m.className=`text-xs text-slate-400 font-mono`,h.classList.add(`hidden`))});var g=document.getElementById(`relawanForm`),_=document.getElementById(`formAlert`);g?.addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`submitBtn`),n=document.getElementById(`btnText`),r=document.getElementById(`btnSpinner`);t.disabled=!0,n.textContent=`Mengirim...`,r.classList.remove(`hidden`),_.classList.add(`hidden`);let i=new FormData(g),a={namaLengkap:i.get(`namaLengkap`),nik:i.get(`nik`),email:i.get(`email`),jabatan:i.get(`jabatan`),jenisKelamin:i.get(`jenisKelamin`),nomorHp:i.get(`nomorHp`),alamatLengkap:i.get(`alamatLengkap`),tempatLahir:i.get(`tempatLahir`),tanggalLahir:i.get(`tanggalLahir`)};try{let e=await fetch(`/api/relawan`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify(a)}),t=await e.json();if(e.ok&&t.success){let e=encodeURIComponent(String(a.namaLengkap));window.location.href=`/terima-kasih?nama=${e}`}else _.className=`mb-5 p-3.5 rounded-xl text-sm font-medium border bg-rose-50 text-rose-800 border-rose-200`,_.textContent=t.message||`Terjadi kesalahan saat memproses data.`,_.classList.remove(`hidden`)}catch(e){_.className=`mb-5 p-3.5 rounded-xl text-sm font-medium border bg-rose-50 text-rose-800 border-rose-200`,_.textContent=`Kesalahan sistem: `+e.message,_.classList.remove(`hidden`)}finally{t.disabled=!1,n.textContent=`Kirim Pendaftaran`,r.classList.add(`hidden`)}}),document.getElementById(`resetBtn`)?.addEventListener(`click`,()=>{g?.reset(),m.textContent=`0/16`,h.classList.add(`hidden`),_.classList.add(`hidden`),i.value=``});"],["E:/website/pendataanrelawan/src/pages/admin.astro?astro&type=script&index=0&lang.ts","document.getElementById(`loginForm`)?.addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`adminPassword`).value,n=document.getElementById(`loginAlert`);try{let e=await fetch(`/api/login`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({password:t})}),r=await e.json();e.ok&&r.success?window.location.reload():(n.textContent=r.message||`Password salah`,n.classList.remove(`hidden`))}catch(e){n.textContent=`Kesalahan: `+e.message,n.classList.remove(`hidden`)}}),document.getElementById(`logoutBtn`)?.addEventListener(`click`,async()=>{await fetch(`/api/login`,{method:`DELETE`}),window.location.href=`/`});"]],"assets":["/bgn.png","/favicon.ico","/favicon.svg","/_astro/DaftarRelawan.astro_astro_type_script_index_0_lang.CeD2W_Rh.js","/_astro/Layout.DMyBZTBH.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"V8aUlIATz1cJmfm96Cpz16Ivs97rZBwHpZc9xAVzVCQ=","sessionConfig":{"driver":"unstorage/drivers/fs-lite","options":{"base":"E:\\website\\pendataanrelawan\\node_modules\\.astro\\sessions"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var mode = "standalone";
var client = "file:///E:/website/pendataanrelawan/dist/client/";
var server = "file:///E:/website/pendataanrelawan/dist/server/";
var port = 4321;
